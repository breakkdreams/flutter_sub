...
class ForgetPayNextPasswordPage extends StatefulWidget {

  String mobile;
  String mobile_code;

  ForgetPayNextPasswordPage({this.mobile,this.mobile_code});

  @override
  _ForgetPayNextPasswordPageState createState() => _ForgetPayNextPasswordPageState();
}
